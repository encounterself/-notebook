...
SELECT billing_month, reconciliation_status, platform_source_status, platform_exclusion_reason, platform_scope_status, platform_price_status, product_effective_status,
  COUNT(*) AS card_count,
...
FROM recon
GROUP BY billing_month, reconciliation_status, platform_source_status, platform_exclusion_reason, platform_scope_status, platform_price_status, product_effective_status
ORDER BY billing_month, reconciliation_status, platform_source_status, platform_scope_status, platform_price_status, product_effective_status
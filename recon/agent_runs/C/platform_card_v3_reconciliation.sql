...
SELECT
  ...
  formal_match_status,
  platform_amount_evidence_status,
  difference_reason,
  ...
  platform_monthly_rent,
  platform_package_price,
  platform_time_zone,
  platform_iccid,
  platform_cycle_start,
  platform_cycle_end,
  platform_cycle_days,
  ...
  platform_candidate_count,
  platform_candidate_product_count,
  platform_candidate_window_count,
  activation_event_count,
  offstock_event_count,

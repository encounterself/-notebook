...
SELECT excel_row_key,
       ...
       imsi,
       excel_iccid, excel_product_name, excel_product_id, charge_type,
       excel_cycle_start, excel_cycle_end, excel_final_start, excel_final_end,
       excel_days, excel_price, excel_amount,
       platform_product_id, platform_product_name, platform_monthly_rent,
       platform_package_price, platform_time_zone, platform_iccid,
       platform_window_source, platform_cycle_start, platform_cycle_end,
       platform_cycle_days, platform_calculated_days, platform_calculated_price,
       platform_calculated_amount, platform_calculated_amount_known,
       day_diff, price_diff, amount_diff, numeric_match_status,
       formal_match_status, platform_amount_evidence_status, rule_id,
       platform_price_state, product_mapping_status, platform_candidate_count,
       platform_candidate_product_count, platform_candidate_window_count,
       activation_event_count, offstock_event_count, replacement_event_count,
       transfer_event_count, difference_reason,
       formal_match_status AS source_match_status
FROM finalized
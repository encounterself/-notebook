...
FROM recon_joined
GROUP BY reconciliation_billing_month, source_match_status, difference_reason, record_side, charge_type
ORDER BY reconciliation_billing_month, record_side, charge_type, source_match_status, difference_reason
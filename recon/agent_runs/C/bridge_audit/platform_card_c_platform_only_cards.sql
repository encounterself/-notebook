...
)SELECT billing_month, stable_platform_card_key, imsi, platform_iccid, platform_product_id, platform_product_name, platform_supplier_id, platform_fact_price, platform_cycle_start, platform_cycle_end, platform_cycle_days, platform_billing_days, platform_baseline_window_rule, platform_calculated_amount, platform_calculated_amount_known, platform_full_amount_evidence_status, last_snapshot_ts, 'PLATFORM_ONLY' AS source_match_status, platform_only_reason FROM platform_only_cards ORDER BY billing_month, imsi, stable_platform_card_key
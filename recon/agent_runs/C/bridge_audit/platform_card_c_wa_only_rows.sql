...
)SELECT official_excel_billing_month AS billing_month, excel_source_file AS source_file, excel_row_key, imsi, excel_product_id, excel_product_name, charge_type, excel_final_start, excel_final_end, excel_days, excel_price, excel_amount, rule_id, 'WA_ONLY' AS source_match_status FROM wa_only_rows ORDER BY official_excel_billing_month, imsi, excel_row_key
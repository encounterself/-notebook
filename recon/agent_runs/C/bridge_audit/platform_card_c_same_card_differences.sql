...
)SELECT official_excel_billing_month AS billing_month, stable_platform_card_key, excel_row_key, imsi, charge_type, rule_id, same_card_difference_category, excel_final_start, excel_final_end, excel_days, platform_calculated_days, day_diff, excel_price, platform_calculated_price, price_diff, excel_amount, platform_calculated_amount, same_card_rule_amount_diff, numeric_match_status, platform_product_mapping_status, formal_match_status, platform_product_id, platform_product_name, platform_supplier_id, platform_iccid, platform_cycle_start, platform_cycle_end, platform_window_source, activation_event_count, offstock_event_count, replacement_event_count, transfer_event_count FROM same_card_excel_rows ORDER BY official_excel_billing_month, imsi, excel_row_key
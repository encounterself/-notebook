...
SELECT official_excel_billing_month, charge_type,
       COUNT(*) AS excel_row_count, COUNT(DISTINCT imsi) AS excel_imsi_count,
       ...
       SUM(CASE WHEN product_mapping_status = 'EXCEL_PRODUCT_ID_NULL_NAME_MISMATCH' THEN 1 ELSE 0 END) AS product_name_mismatch_mapping_count,
       SUM(CASE WHEN product_mapping_status = 'EXCEL_PRODUCT_ID_NULL_NAME_EXACT_ONLY' THEN 1 ELSE 0 END) AS product_name_exact_only_count,

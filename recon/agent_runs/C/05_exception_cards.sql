...
SELECT
  ...
  wa_final_days,
  candidate_days,
  CASE WHEN wa_final_days IS NOT NULL AND candidate_days IS NOT NULL THEN wa_final_days - candidate_days END AS day_error,
  wa_price,
  wa_price_values,
...
ORDER BY billing_month, charge_type, exception_reason, imsi
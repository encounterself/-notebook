...
SELECT excel_row_key, excel_source_file, official_excel_billing_month, imsi,
       ...
       platform_price_state, product_mapping_status, platform_candidate_count, platform_candidate_product_count,
       platform_candidate_window_count, activation_event_count, offstock_event_count,
       replacement_event_count, transfer_event_count, difference_reason,
       source_match_status
FROM finalized
...
SELECT billing_month, reconciliation_status, platform_source_status, COUNT(*) AS row_count FROM recon GROUP BY billing_month, reconciliation_status, platform_source_status ORDER BY billing_month, reconciliation_status, platform_source_status
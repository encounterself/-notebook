...
SELECT
  excel_row_id,
  source_file AS excel_source_file,
  invoice_batch_label AS official_excel_billing_month,
  observed_start_month,
  imsi,
  excel_product_id,
  excel_product_name,
  excel_new_card_imsi_replacement,
  excel_old_card_imsi_replaced,
  excel_transferred_to_wing_simbank,
  excel_sheet_name,
  charge_type,
  excel_cycle_start_date,
  excel_cycle_end_date,
  excel_final_start_date,
  excel_final_end_date,
  excel_days,
  excel_price,
  excel_amount,
  platform_product_id,
  platform_product_name,
  platform_cycle_start_date,
  platform_cycle_end_date,
  platform_product_time_zone,
  cycle_history_time_zone,
  platform_package_price AS platform_calculated_price,
  platform_package_price AS platform_catalog_price,
  platform_package_price_withusd AS platform_catalog_price_withusd,
  cycle_history_package_price,
  platform_price_evidence_status,
  product_catalog_row_count,
  cycle_history_row_count,
  status_snapshot_row_count_20251011,
  status_log_row_count_target_months,
  rule_id,
  proration_denominator_month,
  proration_denominator_days,
...
ORDER BY official_excel_billing_month, excel_source_file, charge_type, imsi, excel_row_id LIMIT 100;

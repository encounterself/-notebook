...
WHERE platform_candidate_count > 0
  AND numeric_match_status <> 'MATCHED'
ORDER BY numeric_match_status, invoice_batch_label, charge_type, ABS(COALESCE(amount_diff, CAST(999999 AS DECIMAL(38,12)))), imsi
LIMIT 500;
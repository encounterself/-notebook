...
SELECT 'CARD_BRIDGE' AS result_type,invoice_batch_label,platform_card_key_type,platform_card_window_key,imsi,platform_product_id,platform_product_name,platform_price,platform_amount,platform_amount_basis,platform_cycle_start_date,platform_cycle_end_date,target_overlap_days,target_period_proof,excel_row_count,excel_distinct_imsi_count,excel_amount,formal_match_count,numeric_match_count,day_mismatch_count,price_mismatch_count,amount_mismatch_count,candidate_presence_count,bridge_reason,bridge_amount
FROM card_bridge_reason
WHERE bridge_reason<>'PLATFORM_ONLY'
ORDER BY invoice_batch_label,bridge_reason,imsi,platform_product_id,platform_cycle_start_date

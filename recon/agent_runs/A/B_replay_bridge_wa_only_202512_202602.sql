...
SELECT 'WA_ONLY' AS result_type,invoice_batch_label,excel_row_id,excel_source_file,observed_start_month,imsi,excel_product_name,charge_type,excel_final_start_date,excel_final_end_date,excel_days,excel_price,excel_amount,platform_candidate_count,bridge_amount
FROM wa_only
ORDER BY invoice_batch_label,imsi,excel_row_id

...
SELECT 'BRIDGE_SUMMARY' AS result_type,p.invoice_batch_label,CAST(NULL AS STRING) AS bridge_reason,
  CAST(NULL AS STRING) AS platform_card_key_type,CAST(NULL AS STRING) AS platform_card_window_key,CAST(NULL AS STRING) AS excel_row_id,
  CAST(NULL AS STRING) AS excel_source_file,CAST(NULL AS STRING) AS observed_start_month,CAST(NULL AS STRING) AS imsi,
  CAST(NULL AS STRING) AS excel_product_name,CAST(NULL AS STRING) AS platform_product_id,CAST(NULL AS STRING) AS platform_product_name,
  CAST(2275 AS BIGINT) AS platform_supplier_id,CAST(NULL AS DECIMAL(38,12)) AS platform_price,CAST(NULL AS DECIMAL(38,12)) AS excel_price,
  CAST(NULL AS DATE) AS platform_cycle_start_date,CAST(NULL AS DATE) AS platform_cycle_end_date,CAST(NULL AS DATE) AS excel_final_start_date,CAST(NULL AS DATE) AS excel_final_end_date,
  p.platform_total AS platform_amount,e.excel_total AS excel_amount,e.excel_row_count AS row_count,e.excel_distinct_imsi_count AS distinct_imsi_count,
  p.platform_card_window_count,p.platform_distinct_imsi_count,p.platform_total,e.excel_total,p.platform_total-e.excel_total AS platform_total_minus_excel_total,
  CAST(NULL AS DECIMAL(38,12)) AS bridge_amount,k.bridge_bucket_sum,(p.platform_total-e.excel_total)-k.bridge_bucket_sum AS bridge_residual,
  p.unproven_platform_card_count,p.platform_only_card_count,p.platform_only_distinct_imsi_count,p.platform_only_amount,
  CAST(NULL AS BIGINT) AS candidate_presence_count,CAST(NULL AS BIGINT) AS formal_match_count,CAST(NULL AS BIGINT) AS numeric_match_count,
  CAST(NULL AS BIGINT) AS day_mismatch_count,CAST(NULL AS BIGINT) AS price_mismatch_count,CAST(NULL AS BIGINT) AS amount_mismatch_count
...
UNION ALL
SELECT 'BRIDGE_BUCKET',b.invoice_batch_label,b.bridge_reason,
  CAST(NULL AS STRING),CAST(NULL AS STRING),CAST(NULL AS STRING),CAST(NULL AS STRING),CAST(NULL AS STRING),CAST(NULL AS STRING),CAST(NULL AS STRING),
  CAST(NULL AS STRING),CAST(NULL AS STRING),CAST(2275 AS BIGINT),CAST(NULL AS DECIMAL(38,12)),CAST(NULL AS DECIMAL(38,12)),
  CAST(NULL AS DATE),CAST(NULL AS DATE),CAST(NULL AS DATE),CAST(NULL AS DATE),CAST(NULL AS DECIMAL(38,12)),CAST(NULL AS DECIMAL(38,12)),
  b.excel_row_count,b.excel_distinct_imsi_count,b.platform_card_window_count,b.platform_distinct_imsi_count,
  CAST(NULL AS DECIMAL(38,12)),CAST(NULL AS DECIMAL(38,12)),CAST(NULL AS DECIMAL(38,12)),b.bridge_amount,
  CAST(NULL AS DECIMAL(38,12)),CAST(NULL AS DECIMAL(38,12)),CAST(NULL AS BIGINT),CAST(NULL AS BIGINT),CAST(NULL AS DECIMAL(38,12)),CAST(NULL AS DECIMAL(38,12)),
  CAST(NULL AS BIGINT),CAST(NULL AS BIGINT),CAST(NULL AS BIGINT),CAST(NULL AS BIGINT),CAST(NULL AS BIGINT),CAST(NULL AS BIGINT)
FROM buckets b
UNION ALL
SELECT 'PLATFORM_CARD',b.invoice_batch_label,b.bridge_reason,b.platform_card_key_type,b.platform_card_window_key,
  CAST(NULL AS STRING),CAST(NULL AS STRING),CAST(NULL AS STRING),b.imsi,CAST(NULL AS STRING),b.platform_product_id,b.platform_product_name,CAST(2275 AS BIGINT),
  b.platform_price,CAST(NULL AS DECIMAL(38,12)),b.platform_cycle_start_date,b.platform_cycle_end_date,CAST(NULL AS DATE),CAST(NULL AS DATE),
  b.platform_amount,b.excel_amount,b.excel_row_count,b.excel_distinct_imsi_count,CAST(1 AS BIGINT),CAST(1 AS BIGINT),
  CAST(NULL AS DECIMAL(38,12)),CAST(NULL AS DECIMAL(38,12)),CAST(NULL AS DECIMAL(38,12)),b.bridge_amount,CAST(NULL AS DECIMAL(38,12)),CAST(NULL AS DECIMAL(38,12)),
  CAST(NULL AS BIGINT),CAST(NULL AS BIGINT),CAST(NULL AS DECIMAL(38,12)),CAST(NULL AS DECIMAL(38,12)),b.candidate_presence_count, b.formal_match_count,b.numeric_match_count,
  b.day_mismatch_count,b.price_mismatch_count,b.amount_mismatch_count
FROM card_bridge_reason b
UNION ALL
SELECT 'WA_ONLY',w.invoice_batch_label,w.bridge_reason,CAST(NULL AS STRING),CAST(NULL AS STRING),w.excel_row_id,w.excel_source_file,w.observed_start_month,w.imsi,w.excel_product_name,
  CAST(NULL AS STRING),CAST(NULL AS STRING),CAST(2275 AS BIGINT),CAST(NULL AS DECIMAL(38,12)),w.excel_price,CAST(NULL AS DATE),CAST(NULL AS DATE),w.excel_final_start_date,w.excel_final_end_date,
  CAST(NULL AS DECIMAL(38,12)),w.excel_amount,CAST(1 AS BIGINT),CAST(1 AS BIGINT),CAST(NULL AS BIGINT),CAST(NULL AS BIGINT),CAST(NULL AS DECIMAL(38,12)),CAST(NULL AS DECIMAL(38,12)),CAST(NULL AS DECIMAL(38,12)),
  w.bridge_amount,CAST(NULL AS DECIMAL(38,12)),CAST(NULL AS DECIMAL(38,12)),CAST(NULL AS BIGINT),CAST(NULL AS BIGINT),CAST(NULL AS BIGINT),CAST(NULL AS DECIMAL(38,12)),CAST(NULL AS BIGINT),CAST(NULL AS BIGINT),CAST(NULL AS BIGINT),CAST(NULL AS BIGINT),CAST(NULL AS BIGINT),CAST(NULL AS BIGINT)
FROM wa_only w
ORDER BY result_type,invoice_batch_label,bridge_reason,imsi,platform_product_id,platform_cycle_start_date

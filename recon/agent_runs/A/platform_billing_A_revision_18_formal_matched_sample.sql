...
SELECT
  ...
  difference_reason AS numeric_difference_reason,
  formal_difference_reason AS difference_reason
FROM platform_proven_formal_rows_final
WHERE formal_match_status = 'MATCHED'
ORDER BY official_excel_billing_month, excel_source_file, charge_type, imsi, excel_row_id LIMIT 10;

...
SELECT 'PLATFORM_ONLY' AS result_type,invoice_batch_label,platform_card_key_type,platform_card_window_key,imsi,platform_supplier_id,platform_product_id,platform_product_name,platform_price,platform_amount,platform_amount_basis,platform_cycle_start_date,platform_cycle_end_date,target_overlap_days,target_period_proof,platform_source_row_count,candidate_presence_count,bridge_reason,bridge_amount
FROM card_bridge_reason
WHERE bridge_reason='PLATFORM_ONLY'
ORDER BY invoice_batch_label,imsi,platform_product_id,platform_cycle_start_date

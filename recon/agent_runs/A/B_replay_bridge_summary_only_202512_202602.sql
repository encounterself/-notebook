...
SELECT p.invoice_batch_label,e.excel_row_count,e.excel_distinct_imsi_count,e.excel_total,p.platform_card_window_count,p.platform_distinct_imsi_count,p.platform_source_row_count,p.unproven_platform_card_count,p.platform_amount_candidate_sum,p.platform_total,p.platform_total-e.excel_total AS platform_total_minus_excel_total,p.platform_only_card_count,p.platform_only_distinct_imsi_count,p.platform_only_amount,e.wa_only_row_count,e.wa_only_distinct_imsi_count,e.wa_only_excel_amount,k.bridge_bucket_sum,(p.platform_total-e.excel_total)-k.bridge_bucket_sum AS bridge_residual
...
ORDER BY p.invoice_batch_label

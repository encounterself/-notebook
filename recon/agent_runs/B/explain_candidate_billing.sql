EXPLAIN WITH cfg AS (
  ...
  SELECT r.billing_month, r.imsi, r.platform_product_id, r.platform_product_name, r.supplier_id,
         ...
         r.monthly_rent_count, r.monthly_rent_values, r.platform_price, r.product_scope_class

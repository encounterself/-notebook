...
SELECT platform_product_id, supplier_id, product_name_values, product_population_status,
  price_value_count, price_values, unique_monthly_rent, product_package_values
FROM product_dim
ORDER BY product_population_status, platform_product_id;
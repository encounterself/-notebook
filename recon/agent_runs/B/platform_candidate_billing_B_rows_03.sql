...
SELECT
  'EXCEL_DETAIL_CANDIDATE' AS result_type,
  excel_row_id, excel_source_file, official_excel_billing_month, observed_start_month,
  imsi, excel_product_id, platform_product_id, platform_supplier_id, excel_product_name, platform_product_name,
  excel_charge_type, excel_new_activation_date, excel_final_start_date, excel_final_end_date, excel_days, platform_calculated_days,
  excel_price, platform_calculated_price, excel_amount, platform_calculated_amount,
  day_diff, price_diff, amount_diff, rule_id, difference_reason, source_match_status, platform_source_table,
  platform_cycle_start_date, platform_cycle_end_date, platform_activation_event_date, activation_date_distance,
  cycle_best_candidate_count, cycle_best_candidate_product_count, cycle_best_candidate_product_ids, platform_price_value_count, platform_price_values,
  snapshot_product_count, snapshot_platform_product_ids, snapshot_lifecycle_status_values, snapshot_dispatch_status_values,
  excel_offstock_date, excel_new_card_imsi_replacement, excel_old_card_imsi_replaced
FROM final_candidate
WHERE excel_row_id BETWEEN 10001 AND 15000
ORDER BY official_excel_billing_month, excel_source_file, imsi, excel_row_id;
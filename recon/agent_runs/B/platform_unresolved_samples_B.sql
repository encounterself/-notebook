...
SELECT official_excel_billing_month, excel_source_file, imsi, excel_charge_type,
  excel_final_start_date, excel_final_end_date, excel_days, platform_calculated_days,
  excel_price, platform_calculated_price, excel_amount, platform_calculated_amount,
  day_diff, price_diff, amount_diff, rule_id, difference_reason, source_match_status,
  platform_product_id, platform_supplier_id, platform_product_name, platform_source_table,
  platform_cycle_start_date, platform_cycle_end_date, platform_activation_event_date, activation_date_distance,
  cycle_best_candidate_count, cycle_best_candidate_product_count, cycle_best_candidate_product_ids,
  snapshot_product_count, snapshot_platform_product_ids, excel_offstock_date,
  excel_new_card_imsi_replacement, excel_old_card_imsi_replaced
FROM final_candidate
WHERE source_match_status<>'MATCHED'
ORDER BY official_excel_billing_month, excel_charge_type, source_match_status, imsi
LIMIT 300;
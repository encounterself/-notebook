...
SELECT reconciliation_billing_month, charge_type, record_side, source_match_status,
...
FROM recon_joined
GROUP BY reconciliation_billing_month, charge_type, record_side, source_match_status
ORDER BY reconciliation_billing_month, charge_type, record_side, source_match_status